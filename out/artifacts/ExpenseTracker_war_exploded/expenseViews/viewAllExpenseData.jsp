...
<table>
    ...
    <c:forEach var="expense" items="${expenses}">
        <tr>
            <td>
                <a href="/mvc_exp/viewExpenseData?id=${expense.id}">
...
<form name="searchByCategoryForm" method="POST" action="/mvc_exp/viewExpensesInCategory">
...
<form name="searchByDateRangeForm" method="POST" action="/mvc_exp/viewExpensesInDateRange">
...
<a href="/">Home</a>
<br>
<a href="/mvc_exp/addExpenseData">Add Expense</a>
<br>
<a href="/mvc_exp/viewAllExpenseData">View All Expenses</a>
</body>
</html>
